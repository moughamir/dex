<script lang="ts">
  ...
  const buttonVariants = cva(
    [
      ...
      "select-none",
      "font-medium",
      "transition-[opacity,transform,box-shadow,border-color,background-color]",
      "duration-(--motion-hover-duration)",
      "active:duration-(--motion-press-duration)",
      "outline-none",
    ...
    ],
    {
      variants: {
        variant: {
          ...
          secondary: ["dex-glass", "text-[color:var(--text-primary)]"],
          ...
          danger: ["bg-[color:var(--dex-danger)]", "text-white"],
        },
